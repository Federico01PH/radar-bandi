...
**Notifiche sul computer.** Stesso canale, senza installare niente: si apre `https://ntfy.sh/<nome-del-canale>`
nel browser e si dà il permesso alle notifiche. Arrivano come quelle del telefono, anche a finestra chiusa,
finché la scheda resta aperta. In alternativa c'è l'app ntfy per Windows e Mac.

**Niente email, di proposito.** Le email richiederebbero l'indirizzo di posta di qualcuno — un account
ntfy con i destinatari verificati uno per uno, oppure la password per le app di una casella Gmail — e
questa piattaforma deve poter cambiare mani senza portarsi dietro la posta personale di chi l'ha messa
in piedi. Chi la eredita e volesse le email le accende dal paragrafo qui sotto, con una casella sua.

### 4 bis. Email, facoltative e spente

Se un giorno servissero anche le email, in
**Settings → Secrets and variables → Actions → New repository secret** si creano questi cinque segreti.
Quando ci sono tutti e cinque, le notifiche partono anche per email; finché mancano, non parte niente:
